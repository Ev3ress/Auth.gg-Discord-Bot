...
module.exports.run = (bot, message, args)=>
{
    ...
    try{
    req({
        uri: `https://developers.auth.gg/LICENSES/?type=count&authorization=${Settings.authkey}`,
        method: "GET"
...
break;
default:
if(JSON.parse(data)["value"] == "0") message.reply(`:x: | No Licenses`)
else message.reply(`:white_check_mark: | ${JSON.parse(data)["value"]} Licenses`)
break;
}
});
}
